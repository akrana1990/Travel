...
class Custom_Recent_Posts_Widget extends WP_Widget {
    ...
    function __construct() {
        $widget_ops = array(
            ...
            'description' => __('Display a list of recent package entries from one or more categories.')
        );
        parent::__construct('custom-recent-posts', __('Custom Recent Packages'), $widget_ops);
    }
        ...
        while ( $crp_widget->have_posts() )
        {
            ...
            <li class="crpw-item">
                ...
                <a href="<?php the_permalink() ?>" title="<?php the_title_attribute(); ?>">
                    <?php
                    $default = array('class' => 'img-widget');

                    the_post_thumbnail('wl_media_sidebar_img', $default);
                    ?>
                </a>
                <?php endif; ?>
