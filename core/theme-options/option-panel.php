    ...
    <div class="wrap" id="weblizar_wrap" >
        ...
        <div id="content_wrap">
            <div class="weblizar-header" >
                <h2><span><?php _e('Theme Settings','weblizar'); ?></span></h2>
                    ...
                    <ul class="options_tabs ui-tabs-nav" role="tablist" id="nav">
                        <li class="active" >
                            ...
                            <ul>
                                ...
                                <li><a href="#Site Title"  id="site-info"><?php _e('Site Title Option','weblizar');?></a></li>
                                <li><a href="#Special Promotions"  id="home-service"><?php _e('Special Promotions','weblizar');?></a></li>
                                <li><a href="#Best Locations"  id="business-module"><?php _e('Best Locations','weblizar');?></a></li>
                            </ul>
                        </li>
