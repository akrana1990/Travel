...
/*
	* Business Module show_re(10) setting
	*/
if(isset($_POST['weblizar_settings_save_business-module']))
{
    if($_POST['weblizar_settings_save_business-module'] == 1)
    {
        foreach($_POST as  $key => $value)
        {
            $wl_theme_options[$key]=sanitize_text_field($_POST[$key]);
    ...
    if($_POST['weblizar_settings_save_business-module'] == 2)
    {
        reset_service_setting();
    }
}
